<div align="center">
  ...
  [![Zed v1.9.0](https://img.shields.io/badge/Zed-v1.9.0-blue?logo=zedindustries&logoColor=white)](https://github.com/zed-industries/zed/releases/tag/v1.9.0)
...
uv run zed-i18n extract --zed-root .cache/zed/v1.9.0-clean-extract
uv run zed-i18n audit-candidates --zed-root .cache/zed/v1.9.0-clean-extract
uv run zed-i18n prepare-translation --language ko-KR --zed-root .cache/zed/v1.9.0-clean-extract
